...
#define INC_DECLARE_STLMAP_CONST( CLASS_NAME, MK, MV, NK, NV )					\
...
#define INC_DECLARE_STLMAP_EMPTY_NONCONST( CLASS_NAME, MK, MV, NK, NV )				\
...
#define CPP_DECLARE_STLMAP_NONCONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )				\
...
#define CPP_DECLARE_STLMAP_CONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )						\
...
#define CPP_DECLARE_STLMAP_EMPTY_NONCONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )				\
																					\
	PREFIX##Const_##CLASS_NAME^ PREFIX##CLASS_NAME::ReadOnlyInstance::get()							\
		{																			\
			if (_readOnly == (Object^)nullptr)										\
...
#define INC_DECLARE_STLMAP( CLASS_NAME, MK, MV, NK, NV, PUBLIC, PRIVATE )			\
ref class Const_##CLASS_NAME;														\
PUBLIC INC_DECLARE_STLMAP_NONCONST( CLASS_NAME, MK, MV, NK, NV )					\
PUBLIC INC_DECLARE_STLMAP_CONST( CLASS_NAME, MK, MV, NK, NV )


#define INC_DECLARE_STLMAP_READONLY( CLASS_NAME, MK, MV, NK, NV, PUBLIC, PRIVATE )	\
ref class Const_##CLASS_NAME;														\
PRIVATE INC_DECLARE_STLMAP_EMPTY_NONCONST( CLASS_NAME, MK, MV, NK, NV )				\
PUBLIC INC_DECLARE_STLMAP_CONST( CLASS_NAME, MK, MV, NK, NV )



#define CPP_DECLARE_STLMAP( PREFIX, CLASS_NAME, MK, MV, NK, NV )						\
CPP_DECLARE_STLMAP_NONCONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )						\
CPP_DECLARE_STLMAP_CONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )


#define CPP_DECLARE_STLMAP_READONLY( PREFIX, CLASS_NAME, MK, MV, NK, NV )				\
CPP_DECLARE_STLMAP_EMPTY_NONCONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )					\
CPP_DECLARE_STLMAP_CONST( PREFIX, CLASS_NAME, MK, MV, NK, NV )
