...
#define INC_STLLIST_REMOVE_AND_UNIQUE_DEFINITIONS(M)								\
	void Remove(M value);															\
																					\
	void Unique()																	\
	{																				\
...
#define CPP_STLLIST_REMOVE_AND_UNIQUE_DEFINITIONS(PREFIX,CLASS_NAME,M,N)			\
	void PREFIX##CLASS_NAME::Remove(M value)										\
	{																				\
		_native->remove(ToNative<M,N>( value ));									\
	}
...
#define INC_DECLARE_STLLIST_NONCONST( CLASS_NAME, M, N )							\
ref class CLASS_NAME : Collections::Generic::IEnumerable<M>							\
{																					\
public:																				\
	typedef std::list<N> Container;													\
...
public:																				\
	...
	{																				\
		_native->reverse();															\
																					...
																					\
	/*Sort removed because it requires operator < implementation by the class*/		\
	/*void Sort()			*/														\
	/*{						*/														\
	/*	_native->sort();	*/														\
	/*}						*/														\
																					\
	INC_STLLIST_DEFINE_REMOVE_AND_UNIQUE(M)											\
};
...
#define INC_DECLARE_STLLIST_CONST( CLASS_NAME, M, N )								\
...
#define INC_DECLARE_STLLIST_EMPTY_NONCONST( CLASS_NAME, M, N )						\
...
#define CPP_DECLARE_STLLIST_NONCONST( PREFIX, CLASS_NAME, M, N )							\
	...
	{																				\
		_native->resize(newSize, ToNative<M,N>( value ));							\
																					...
																					\
																					\
	void PREFIX##CLASS_NAME::AddFirst(M value)										\
	{																				\
		_native->push_front(ToNative<M,N>( value ));								\
	}																				\
																					\
	CPP_STLLIST_DEFINE_REMOVE_AND_UNIQUE(PREFIX,CLASS_NAME,M,N)
...
#define CPP_DECLARE_STLLIST_CONST( PREFIX, CLASS_NAME, M, N )						\
...
#define CPP_DECLARE_STLLIST_EMPTY_NONCONST( PREFIX, CLASS_NAME, M, N )						\
																					\
	PREFIX##Const_##CLASS_NAME^ PREFIX##CLASS_NAME::ReadOnlyInstance::get()							\
		{																			\
			if (_readOnly == (Object^)nullptr)										\
...
#define INC_DECLARE_STLLIST( CLASS_NAME, M, N, PUBLIC, PRIVATE )					\
ref class Const_##CLASS_NAME;														\
PUBLIC INC_DECLARE_STLLIST_NONCONST( CLASS_NAME, M, N )							\
PUBLIC INC_DECLARE_STLLIST_CONST( CLASS_NAME, M, N )


#define INC_DECLARE_STLLIST_READONLY( CLASS_NAME, M, N, PUBLIC, PRIVATE )			\
ref class Const_##CLASS_NAME;														\
PRIVATE INC_DECLARE_STLLIST_EMPTY_NONCONST( CLASS_NAME, M, N )						\
PUBLIC INC_DECLARE_STLLIST_CONST( CLASS_NAME, M, N )



#define CPP_DECLARE_STLLIST( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLLIST_NONCONST( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLLIST_CONST( PREFIX, CLASS_NAME, M, N )


#define CPP_DECLARE_STLLIST_READONLY( PREFIX, CLASS_NAME, M, N )							\
CPP_DECLARE_STLLIST_EMPTY_NONCONST( PREFIX, CLASS_NAME, M, N )								\
CPP_DECLARE_STLLIST_CONST( PREFIX, CLASS_NAME, M, N )
