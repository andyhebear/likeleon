...
#define INC_DECLARE_STLMULTISET_NONCONST( CLASS_NAME, M, N )						\
ref class CLASS_NAME : Collections::Generic::IEnumerable<M>							\
{																					\
public:																				\
	typedef std::multiset<N> Container;												\
...
#define INC_DECLARE_STLMULTISET_CONST( CLASS_NAME, M, N )								\
...
#define INC_DECLARE_STLMULTISET_EMPTY_NONCONST( CLASS_NAME, M, N )						\
...
#define CPP_DECLARE_STLMULTISET_NONCONST( PREFIX, CLASS_NAME, M, N )							\
	...
	{																				\
		_native->erase(ToNative<M,N>( value ));										\
																					...
																					\
	PREFIX##CLASS_NAME::Iterator^ PREFIX##CLASS_NAME::Insert(M value)								\
	{																				\
		return _native->insert( ToNative<M,N>( value ) );							\
	}																				\
																					\
	...
	{																				\
		return _native->upper_bound(ToNative<M,N>( value ));						\
																					...
																					\
	int PREFIX##CLASS_NAME::CountValues(M value)									\
	{																				\
		return _native->count(ToNative<M,N>( value ));								\
	}
...
#define CPP_DECLARE_STLMULTISET_CONST( PREFIX, CLASS_NAME, M, N )								\
	...
	{																				\
		return _native->upper_bound(ToNative<M,N>( value ));						\
																					...
																					\
	int PREFIX##Const_##CLASS_NAME::CountValues(M value)							\
	{																				\
		return _native->count(ToNative<M,N>( value ));								\
	}
...
#define CPP_DECLARE_STLMULTISET_EMPTY_NONCONST( PREFIX, CLASS_NAME, M, N )			\
																					\
	PREFIX##Const_##CLASS_NAME^ PREFIX##CLASS_NAME::ReadOnlyInstance::get()			\
		{																			\
			if (_readOnly == (Object^)nullptr)										\
...
#define INC_DECLARE_STLMULTISET( CLASS_NAME, M, N, PUBLIC, PRIVATE )					\
ref class Const_##CLASS_NAME;														\
PUBLIC INC_DECLARE_STLMULTISET_NONCONST( CLASS_NAME, M, N )							\
PUBLIC INC_DECLARE_STLMULTISET_CONST( CLASS_NAME, M, N )


#define INC_DECLARE_STLMULTISET_READONLY( CLASS_NAME, M, N, PUBLIC, PRIVATE )			\
ref class Const_##CLASS_NAME;														\
PRIVATE INC_DECLARE_STLMULTISET_EMPTY_NONCONST( CLASS_NAME, M, N )						\
PUBLIC INC_DECLARE_STLMULTISET_CONST( CLASS_NAME, M, N )



#define CPP_DECLARE_STLMULTISET( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLMULTISET_NONCONST( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLMULTISET_CONST( PREFIX, CLASS_NAME, M, N )


#define CPP_DECLARE_STLMULTISET_READONLY( PREFIX, CLASS_NAME, M, N )							\
CPP_DECLARE_STLMULTISET_EMPTY_NONCONST( PREFIX, CLASS_NAME, M, N )								\
CPP_DECLARE_STLMULTISET_CONST( PREFIX, CLASS_NAME, M, N )
