...
#define INC_DECLARE_STLVECTOR_NONCONST( CLASS_NAME, M, N )							\
ref class CLASS_NAME : Collections::Generic::IEnumerable<M>							\
{																					\
public:																				\
	typedef std::vector<N> Container;												\
...
#define INC_DECLARE_STLVECTOR_CONST( CLASS_NAME, M, N )								\
...
#define INC_DECLARE_STLVECTOR_EMPTY_NONCONST( CLASS_NAME, M, N )						\
...
#define CPP_DECLARE_STLVECTOR_NONCONST( PREFIX, CLASS_NAME, M, N )							\
...
#define CPP_DECLARE_STLVECTOR_CONST( PREFIX, CLASS_NAME, M, N )								\
...
#define INC_DECLARE_STLVECTOR( CLASS_NAME, M, N, PUBLIC, PRIVATE )					\
ref class Const_##CLASS_NAME;														\
PUBLIC INC_DECLARE_STLVECTOR_NONCONST( CLASS_NAME, M, N )							\
PUBLIC INC_DECLARE_STLVECTOR_CONST( CLASS_NAME, M, N )


#define INC_DECLARE_STLVECTOR_READONLY( CLASS_NAME, M, N, PUBLIC, PRIVATE )			\
ref class Const_##CLASS_NAME;														\
PRIVATE INC_DECLARE_STLVECTOR_EMPTY_NONCONST( CLASS_NAME, M, N )						\
PUBLIC INC_DECLARE_STLVECTOR_CONST( CLASS_NAME, M, N )



#define CPP_DECLARE_STLVECTOR( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLVECTOR_NONCONST( PREFIX, CLASS_NAME, M, N )									\
CPP_DECLARE_STLVECTOR_CONST( PREFIX, CLASS_NAME, M, N )


#define CPP_DECLARE_STLVECTOR_READONLY( PREFIX, CLASS_NAME, M, N )							\
CPP_DECLARE_STLVECTOR_EMPTY_NONCONST( PREFIX, CLASS_NAME, M, N )								\
CPP_DECLARE_STLVECTOR_CONST( PREFIX, CLASS_NAME, M, N )
