...
namespace Mogre
{
	...
	{
		static_cast<Ogre::RenderWindow*>(_native)->swapBuffers( waitForVSync );
	}
	...
	{
		static_cast<Ogre::RenderWindow*>(_native)->update( );
	}
	
	void RenderWindow::Update( bool swapBuffers )
	{
		static_cast<Ogre::RenderWindow*>(_native)->update( swapBuffers );
	}
