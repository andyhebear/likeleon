	...
	*/
	...
	public:
		...
		*/
		...
		class _OgreExport ManualObjectSection : public Renderable, public CLRObject
		{
		protected:
		...
		public:
			DECLARE_INIT_CLROBJECT_METHOD_OVERRIDE(ManualObjectSection);
		...
		public:
			DECLARE_INIT_CLROBJECT_METHOD_OVERRIDE(ManualObjectSectionShadowRenderable);
